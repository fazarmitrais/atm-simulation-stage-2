...
func (m *AccountRepositoryMock) GetAll(ctx context.Context) ([]*entity.Account, error) {
	args := m.Called(ctx)
	if args.Get(0) == nil && args.Get(1) == nil {
		return nil, nil
	}
...
func (m *AccountRepositoryMock) Store(ctx context.Context, accounts []*entity.Account) error {
